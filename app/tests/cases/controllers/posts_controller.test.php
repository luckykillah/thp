...
/* Posts Test cases generated on: 2012-12-15 20:42:55 : 1355622175*/
...
class PostsControllerTestCase extends CakeTestCase {
	var $fixtures = array('app.post', 'app.category', 'app.goal', 'app.strategy', 'app.update', 'app.tag', 'app.posts_tag', 'app.updates_tag', 'app.categories_goal', 'app.categories_post');
